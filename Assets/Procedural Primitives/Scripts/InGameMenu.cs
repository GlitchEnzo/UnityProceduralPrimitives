...
public class InGameMenu : MonoBehaviour 
{
	...
	private PrimitiveType prevPrimitiveType = PrimitiveType.Lathe;
	...
	GUIStyle listStyle;
	EnumComboBox comboBoxControl = new EnumComboBox();
	...
	void OnGUI()
	{
		...
		primitiveType = (PrimitiveType)comboBoxControl.List(new Rect(100, 2, 100, 20), prevPrimitiveType, listStyle);
		...
		//if (GUILayout.Button("Create"))
		{
			...
			{
			case PrimitiveType.Box:
				filter.sharedMesh.CreateBox(width, height, depth, widthDivisions, heightDivisions, depthDivisions);
				break;
			case PrimitiveType.Circle:
			...
			case PrimitiveType.Plane:
				...
				break;
			case PrimitiveType.Ring:
				filter.sharedMesh.CreateRing(innerRadius, outerRadius, segments, phiSegments, startAngle, angularSize);
				break;
			case PrimitiveType.Sphere:
				filter.sharedMesh.CreateSphere(radius, slices, stacks, phiStart, phiLength, thetaStart, thetaLength);
				break;
			case PrimitiveType.Torus:
				filter.sharedMesh.CreateTorus(radius, tube, radialSegments, tubularSegments, arc);
				break;
			case PrimitiveType.TorusKnot:
				filter.sharedMesh.CreateTorusKnot(radius, tube, radialSegments, tubularSegments, p, q, heightScale);
				break;
			}
		}
