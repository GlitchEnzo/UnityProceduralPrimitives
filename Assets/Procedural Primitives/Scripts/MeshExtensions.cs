...
public static class MeshExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="Mesh"/> out to the hard drive as an asset.
    /// </summary>
    ...
    public static void CreateAsset(this Mesh mesh)
    {
        ...
        AssetDatabase.CreateAsset(mesh, string.Format(MeshPath, mesh.name));
#endif
    }
	...
	public static void CreateBox(this Mesh mesh, float width, float height, float depth, int widthSegments, int heightSegments, int depthSegments)
	{
		mesh.name = "Box";
		mesh.Clear();
		...
		BuildBoxSide(ref vertices, ref uvs, ref triangles, 2, 1, -1, -1, depth, height,  width_half,  widthSegments, heightSegments, depthSegments); // px
		BuildBoxSide(ref vertices, ref uvs, ref triangles, 2, 1,  1, -1, depth, height, -width_half,  widthSegments, heightSegments, depthSegments); // nx
		BuildBoxSide(ref vertices, ref uvs, ref triangles, 0, 2,  1,  1, width, depth,   height_half, widthSegments, heightSegments, depthSegments); // py
		BuildBoxSide(ref vertices, ref uvs, ref triangles, 0, 2,  1, -1, width, depth,  -height_half, widthSegments, heightSegments, depthSegments); // ny
		BuildBoxSide(ref vertices, ref uvs, ref triangles, 0, 1,  1, -1, width, height,  depth_half,  widthSegments, heightSegments, depthSegments); // pz
		BuildBoxSide(ref vertices, ref uvs, ref triangles, 0, 1, -1, -1, width, height, -depth_half,  widthSegments, heightSegments, depthSegments); // nz
	...
	private static void BuildBoxSide(ref List<Vector3> vertices, ref List<Vector2> uvs, ref List<int> triangles, int u, int v, int udir, int vdir, float width, float height, float depth, int widthSegments, int heightSegments, int depthSegments) 
	{
		int w = 2;
		int ix;
		int iy;
	...
	/// <param name="startAngle">The starting angle of the circle.  Usually 0.</param>
	/// <param name="angularSize">The angular size of the circle.  2 pi is a full circle. Pi is a half circle.</param>
	public static void CreateCylinder(this Mesh mesh, float topRadius, float bottomRadius, float height, int radialSegments, int heightSegments, bool openEnded)
	{
		mesh.name = "Cylinder";
		mesh.Clear();
	...
	public static void CreateLathe(this Mesh mesh, List<Vector3> points, int segments, float phiStart, float phiLength)
	{
		mesh.name = "Lathe";
		mesh.Clear();
...
//				                               ] );
	...
	/// <param name="startAngle">The starting angle of the circle.  Usually 0.</param>
	/// <param name="angularSize">The angular size of the circle.  2 pi is a full circle. Pi is a half circle.</param>
	public static void CreateSphere(this Mesh mesh, float radius, int widthSegments, int heightSegments, float phiStart, float phiLength, float thetaStart, float thetaLength)
	{
		mesh.name = "Sphere";
		mesh.Clear();
	...
	/// <param name="startAngle">The starting angle of the circle.  Usually 0.</param>
	/// <param name="angularSize">The angular size of the circle.  2 pi is a full circle. Pi is a half circle.</param>
	public static void CreateTorus(this Mesh mesh, float radius, float tube, int radialSegments, int tubularSegments, float arc)
	{
		mesh.name = "Torus";
		mesh.Clear();
	...
	public static void CreateTorusKnot(this Mesh mesh, float radius, float tube, int radialSegments, int tubularSegments)
	{
	...
	/// <param name="startAngle">The starting angle of the circle.  Usually 0.</param>
	/// <param name="angularSize">The angular size of the circle.  2 pi is a full circle. Pi is a half circle.</param>
	public static void CreateTorusKnot(this Mesh mesh, float radius, float tube, int radialSegments, int tubularSegments, int p, int q, float heightScale)
	{
		mesh.name = "TorusKnot";
		mesh.Clear();
	...
	public static void CreateRing(this Mesh mesh, float innerRadius, float outerRadius, int thetaSegments, int phiSegments, float thetaStart, float thetaLength)
	{
		mesh.name = "Ring";
		mesh.Clear();
