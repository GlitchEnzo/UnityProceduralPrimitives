...
public static class GameObjectExtensions
{
	...
	public static void CreateCircle(this GameObject gameObject, float radius, int segments, float startAngle, float angularSize)
	{
		Mesh mesh = new Mesh();
	...
	public static void CreatePlane(this GameObject gameObject, float width, float height, int widthSegments, int heightSegments)
	{
		Mesh mesh = new Mesh();
	...
	public static void CreateBox(this GameObject gameObject, float width, float height, float depth, int widthSegments, int heightSegments, int depthSegments)
	{
		Mesh mesh = new Mesh();
